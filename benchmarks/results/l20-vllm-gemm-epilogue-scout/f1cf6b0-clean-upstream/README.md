...
- Path: `/workspace/vllm-clean`
- Branch: `main`
- Commit: `f1cf6b0`
- Dirty: `False` (0 status lines)
- Local L20 patch present: `False`
...
| Blocker | `True` | rescan a clean vLLM checkout before publishing an upstream diff |
